                        ...
                        <div className="col-lg-8 col-md-8">
                            <div className="slider-area">
                                <div className="slider-active owl-carousel owl-loaded owl-drag">
                                    ...
                                    {/* Begin Single Slide Area */}
                                    {/* Single Slide Area End Here */}
                                    <div className="owl-stage-outer owl-height" style={{ height: '475px' }}><div className="owl-stage" style={{ transform: 'translate3d(-2310px, 0px, 0px)', transition: 'all 0.25s ease 0s', width: '5390px' }}><div className="owl-item cloned" style={{ width: '770px' }}><div className="single-slide align-center-left animation-style-02 bg-2">
                                    ...
                                    </div></div><div className="owl-item active" style={{ width: '770px' }}><div className="single-slide align-center-left animation-style-02 bg-2">
                                        <div className="slider-progress" />
                                        <div className="slider-content">
                                            <h5>Sale Offer <span>Black Friday</span> This Week</h5>
                                            <h2>Work Desk Surface Studio 2018</h2>
                                    ...
                                    </div></div><div className="owl-item" style={{ width: '770px' }}><div className="single-slide align-center-left animation-style-01 bg-3">
                                        <div className="slider-progress" />
                                        <div className="slider-content">
                                            <h5>Sale Offer <span>-10% Off</span> This Week</h5>
                                            <h2>Phantom 4 Pro+ Obsidian</h2>
